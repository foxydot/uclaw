...
//frack it, I'm doing my own 
function qtClick(id){
	  var container = $('#quicktabs_container_100');
	  var tabpage = container.find('#quicktabs_tabpage_100_' + id);
	  var tab = $('#quicktabs-tab-'+id);
	  
	  tab.parents('li').siblings().removeClass('active');
	  tab.parents('li').addClass('active');

	  // Hide all tabpages.
	  container.children().addClass('quicktabs-hide');

	  // Show the active tabpage.
	  if (tabpage.hasClass('quicktabs_tabpage')) {
	    tabpage.removeClass('quicktabs-hide');
	  }
