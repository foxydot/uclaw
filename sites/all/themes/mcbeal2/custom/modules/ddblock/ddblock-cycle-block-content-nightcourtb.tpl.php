...
/*!
 * Dynamic display block module template: nightcourtb - content template
...
$css_location = $directory .'/custom/modules/ddblock/'.$custom_template. '/ddblock-cycle-'.$custom_template. '.css';
drupal_add_css($css_location, 'template', 'all', FALSE);	
?>
