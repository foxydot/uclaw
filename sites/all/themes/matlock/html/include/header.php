...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
	    <title>UC College of Law</title>
	    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	    
	    <link rel="shortcut icon" href="/uc/favicon.ico" type="image/x-icon" />
	    
	    <!-- Le styles -->
	    <link href="assets/css/bootstrap.css" rel="stylesheet">
	    <link href="assets/fonts/ss-social-regular.css" rel="stylesheet">
		...
		<script src="//use.typekit.net/joq3zvd.js"></script>
		...
		<header>
			...
			<div class="row top-bar">
				<div class="container">
					<div class="row">
						<div class="span6">
							<a href="http://law.uc.edu" class="brandmark">
								<img src="assets/img/logos.jpg" alt="UC College of Law">
							</a>
						</div>
